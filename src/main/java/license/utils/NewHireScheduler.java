...
public class NewHireScheduler {

    static boolean debug = false, activeMail = false;
    static String mail_host = "";
    static Logger logger = LogManager.getLogger(NewHireScheduler.class);
    int month = 8, day = 20, year=2024;
    Date startDate;
    public NewHireScheduler(String date){
	...
	try{
	    String jobName = "new_hire_"+month+"_"+day+"_"+year;
	    String groupName = "new_hire";	    
	    JobDetail job = JobBuilder.newJob(NewHireJob.class)
