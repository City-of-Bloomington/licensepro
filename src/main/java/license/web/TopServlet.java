...
public class TopServlet extends HttpServlet {
	...
	try{
	    ...
	    str = context.getInitParameter("msSqlUrl");
	    if(str != null) msSqlUrl = str;
	    str = context.getInitParameter("msDb");
	    if(str != null) msDb = str;
	    str = context.getInitParameter("msUser");
	    if(str != null) msUser = str;
	    str = context.getInitParameter("msPass");
	    if(str != null) msPass = str;
