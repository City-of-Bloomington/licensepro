...
<s:form action="check" id="form_id" method="post" >
  ...
  <s:if test="id == ''">
      ...
      any more (left, retired, ..etc) against the New World database.<br />
      All the inactive employees will be listed below where you can <br />confirm that they are active/inactive. <br />
      This procedure will run once on the beginning of every month automactically. If not started yet you can click on the 'Start' button below.
       <br />
  </s:if>
  ...
  <div class="tt-row-container">
      ...
      <s:else>
	  <s:submit name="action" type="button" value="Start Schedule" class="fn1-btn"/></dd>
	  <s:submit name="action" type="button" value="Run Now" class="fn1-btn"/></dd>	  
      </s:else>
