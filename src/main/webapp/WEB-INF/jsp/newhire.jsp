...
<s:form action="newhire" id="form_id" method="post" >
  ...
  <s:if test="id == ''">
	  ...
	  The process will run once every month automactically once it started.
	  <br />
	  If not started yet, you click on 'Start' button below to start the
	  scheduling.
	  <br />
      </p>
  </s:if>
  <div class="tt-row-container">
      ...
      <s:else>
	  <s:submit name="action" type="button" value="Start Schedule" class="fn1-btn"/>
	  <s:submit name="action" type="button" value="Run Now" class="fn1-btn"/>	  
      </s:else>
  </div>
</s:form>
